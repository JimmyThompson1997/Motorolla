window.PUCKY_UI_ICONS = {
  MATERIAL_SYMBOLS: {
    ...
    check: {
      filled: '<path d="m9 16.2-3.5-3.5L4.1 12.1 9 17l10.9-10.9-1.4-1.4L9 16.2Z"/>',
      outline: '<path d="m5 12.2 3.4 3.4L19 5.8"/>'
    },
    checklist: {
    ...
    photo_camera: {
      filled: '<path d="M7 6h2.2l1.4-1.5h2.8L14.8 6H17c1.1 0 2 .9 2 2v8.5c0 1.1-.9 2-2 2H7c-1.1 0-2-.9-2-2V8c0-1.1.9-2 2-2Zm5 10a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Z"/>',
      outline: '<path d="M7 6.5h2.1l1.4-1.5h3l1.4 1.5H17c.8 0 1.5.7 1.5 1.5v8.5c0 .8-.7 1.5-1.5 1.5H7c-.8 0-1.5-.7-1.5-1.5V8C5.5 7.2 6.2 6.5 7 6.5Z"/><circle cx="12" cy="12.5" r="3"/>'
    },
    note: {
