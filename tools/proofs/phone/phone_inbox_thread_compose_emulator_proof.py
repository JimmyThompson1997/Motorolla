...
DEFAULT_BROWSER_HELPER = ROOT / "tools" / "proofs" / "phone" / "phone_walkie_thread_proof_browser.js"
...
def main() -> int:
    ...
    try:
        ...
        compose_url = with_query(args.page_url, {"api_token": args.api_token, "reset_nav": "1"})
        ...
        compose_payload = run_browser_helper(
            ...
            [
                ...
                {"kind": "set_proof_reply_delay_ms", "value": 3500},
                ...
                {"kind": "screenshot", "path": str(args.report_dir / "05-thinking-feed-webview.png")},
                {"kind": "click_selector", "selector": "article.card-outbound"},
