...
async function openAudioControls(page, selector, timeoutMs) {
  ...
  if (controlCount <= 0) {
    ...
    return {
      checked: false,
      reason: "Card detail did not expose an \"Open audio controls\" action",
      before
    };
  }
...
async function main() {
  ...
  try {
    ...
    logAction(actions, "inbox_audio_controls", {
      dark: darkFeedAudioControls,
      light: lightInboxAudioControls,
    });
    if (darkFeedAudioControls.checked && lightInboxAudioControls.checked) {
