...
public final class CapabilityReporter {
    ...
    private JSONArray capabilities() {
        ...
        Json.add(out, cap("ui.web_shell", "ui.surface.get/ui.bundle.status",
                "implemented", "yes", "visible", null, "self_reported",
                "Hosts the VM-served web UI and reports live WebView surface identity; visible feed rendering is VM-owned."));
